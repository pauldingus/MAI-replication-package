...
def prepare_properties(locGroup, loc, propToDrop):  
    ...
    prop_path = f'{repl_pkg_path}\\datasets\\intermediate_outputs\\{locGroup}_properties_propEx_{locGroup}_{loc}.csv'
...
def activity_processor(loc, GEEbucket, locGroup,repl_pkg_path):
    ...
    df = pd.read_csv(f'{repl_pkg_path}\\datasets\\intermediate_outputs\\{locGroup}_measures_exportAct5_maxpMax{loc}_w7.csv')
