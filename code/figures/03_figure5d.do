...
preserve
	...
	tw (scatter activity_harmonized_2018 gs_rain_shock, mcolor("$color1") lcolor("$color1")) ///
	   ...
	   ,  legend(off) name(shocks, replace) title("{bf:d}", pos(10) color(black)  size(*0.8)) ///
	ylabel(100(10)120, angle(0)) yscale(range(100(10)120)) ///
	   ...
	   xtitle("Rainfall shocks during prev. growing season") ytitle("Market activity during harvest season") ///
